...
function listenToEvent() {
  ...
  listener.on("OrderCreated", async (Oid, orderType, tokenA, tokenB, baseAmount, quoteAmount,creator, event) => {
    ...
    const cquoteAmount=tokenB==="0xe9e7CEA3DedcA5984780Bafc599bD69ADd087D56"|| tokenB==="0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c" || tokenB==="0x55d398326f99059fF775485246999027B3197955"?convert(quoteAmount):parseFloat(baseAmount.toString()) / 100000000
    const buy="buy"
